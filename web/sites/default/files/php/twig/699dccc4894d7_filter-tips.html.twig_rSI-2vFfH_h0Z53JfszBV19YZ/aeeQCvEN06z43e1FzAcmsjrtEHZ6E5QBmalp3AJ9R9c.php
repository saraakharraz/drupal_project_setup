...
class __TwigTemplate_11541f84269bb23000633dca97d1ef8a extends Template
{
...
$context["name"]))];
    ...
    ";
                ...
                if ((($tmp = Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["tip"], "list", [], "any", false, false, true, 43))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    ...
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar((((($tmp = ($context["long"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("filter-tips--long") : ("filter-tips--short")));
                    yield "\">
      ";
                    // line 45
                    $context['_parent'] = $context;
...
($context["long"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/filter/filter-tips.html.twig", "/usr/local/var/www/drupal/web/core/themes/olivero/templates/filter/filter-tips.html.twig");
    }
