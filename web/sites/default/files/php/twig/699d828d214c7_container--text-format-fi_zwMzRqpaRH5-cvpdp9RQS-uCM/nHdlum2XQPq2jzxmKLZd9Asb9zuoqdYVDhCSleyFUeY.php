...
class __TwigTemplate_819935e015b58d8e966ad310fb979c8c extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 18
        $context["classes"] = [(((($tmp =         // line 19
($context["has_parent"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("js-form-wrapper") : ("")), (((($tmp =         // line 20
($context["has_parent"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-wrapper") : ("")), "filter-guidelines"];
        // line 24
        yield "<div";
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/text_format/container--text-format-filter-guidelines.html.twig", "/usr/local/var/www/drupal/web/core/themes/claro/templates/text_format/container--text-format-filter-guidelines.html.twig");
    }
