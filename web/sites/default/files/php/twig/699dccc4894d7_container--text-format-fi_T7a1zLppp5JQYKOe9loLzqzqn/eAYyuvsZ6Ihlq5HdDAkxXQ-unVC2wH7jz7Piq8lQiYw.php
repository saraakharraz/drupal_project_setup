...
class __TwigTemplate_64961686f068cdf8207eee8d1363d9c6 extends Template
{
...
($context["has_parent"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-wrapper") : ("")), "filter-wrapper"];
        // line 24
        yield "<div";
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/text_format/container--text-format-filter-wrapper.html.twig", "/usr/local/var/www/drupal/web/core/themes/claro/templates/text_format/container--text-format-filter-wrapper.html.twig");
    }
