...
class __TwigTemplate_97648197285c5e9177fc6cfaf600cb3e extends Template
{
...
($context["long"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "/usr/local/var/www/drupal/web/core/themes/claro/templates/filter/filter-tips.html.twig");
    }
