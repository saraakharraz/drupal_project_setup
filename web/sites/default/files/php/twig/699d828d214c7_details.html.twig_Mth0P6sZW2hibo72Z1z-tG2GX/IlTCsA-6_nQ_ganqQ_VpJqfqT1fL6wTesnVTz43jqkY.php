...
class __TwigTemplate_8caadd5de1d52375e4ebb4337cd63f95 extends Template
{
...
($context["disabled"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("is-disabled") : (""))];
            // line 83
            yield "        <div";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["description_attributes"] ?? null), "addClass", [($context["description_classes"] ?? null)], "method", false, false, true, 83), "html", null, true);
            yield ">";
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/details.html.twig", "/usr/local/var/www/drupal/web/core/themes/claro/templates/details.html.twig");
    }
