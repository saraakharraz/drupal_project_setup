...
class __TwigTemplate_ab97a39f2e9a374fe68408e1d030c8c5 extends Template
{
...
($context["default_row_class"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("views-row") : ("")), "media-library-item", "media-library-item--grid"];
            // line 30
            yield "    <div";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "attributes", [], "any", false, false, true, 30), "addClass", [($context["row_classes"] ?? null)], "method", false, false, true, 30), "html", null, true);
            yield ">";
            // line 31
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/media-library/views-view-unformatted--media-library.html.twig", "/usr/local/var/www/drupal/web/core/themes/claro/templates/media-library/views-view-unformatted--media-library.html.twig");
    }
