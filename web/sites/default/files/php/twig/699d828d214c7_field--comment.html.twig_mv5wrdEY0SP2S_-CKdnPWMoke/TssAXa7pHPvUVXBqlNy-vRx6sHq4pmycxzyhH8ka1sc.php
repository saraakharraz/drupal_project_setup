...
class __TwigTemplate_cd1067727145271bf8041a11c1610aba extends Template
{
...
<section";
  ...
  ";
    ...
    <h2";
            ...
            // line 38
            if ((($tmp = ($context["comments"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 39
  ...
  ";
      ...
      ";
            // line 47
            if ((($tmp = ($context["user_picture"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 48
...
";
    ...
    {
        return new Source("", "core/themes/olivero/templates/field/field--comment.html.twig", "/usr/local/var/www/drupal/web/core/themes/olivero/templates/field/field--comment.html.twig");
    }
