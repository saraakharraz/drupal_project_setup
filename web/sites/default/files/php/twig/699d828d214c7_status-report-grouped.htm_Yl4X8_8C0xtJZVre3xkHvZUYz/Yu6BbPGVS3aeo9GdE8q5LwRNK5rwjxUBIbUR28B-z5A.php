...
class __TwigTemplate_009508c1a5bdeab2e14a6c29e9176e67 extends Template
{
...
$context["group"], "type", [], "any", false, false, true, 32), ["warning", "error"])) ? (("system-status-report__status-icon system-status-report__status-icon--" . CoreExtension::getAttribute($this->env, $this->source, $context["group"], "type", [], "any", false, false, true, 32))) : (""))];
                ...
                ";
                // line 36
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["requirement"], "severity_title", [], "any", false, false, true, 36)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 37
              ...
              <div class=\"system-status-report__entry__value\">
                ...
                ";
                // line 43
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["requirement"], "description", [], "any", false, false, true, 43)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 44
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/status-report-grouped.html.twig", "/usr/local/var/www/drupal/web/core/themes/claro/templates/status-report-grouped.html.twig");
    }
